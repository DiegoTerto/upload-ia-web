      ...
      <main className='flex-1 p-6 flex gap-6'>
        <div className="flex flex-col flex-1 gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            Lembre-se: Voce pode utilizar a veriavel <code className="text-violet-400">{'{transcription}'}</code> no seu prompt para adicionar o conteudo da trancricao do video selecionado
          </p>
        </div>
        <aside className="w-80 space-y-6">
          <form className="space-y-6">
            ...
            <div className='space-y-2'>
              <Label htmlFor="transcription-prompt">Prompt de transcricao</Label>
              <Textarea
